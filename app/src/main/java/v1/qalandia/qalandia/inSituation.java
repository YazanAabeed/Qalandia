...
public class inSituation extends Activity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.in_situation);

        Intent getData = getIntent();
        objectIdCheck = getData.getStringExtra("objectId");

        situations = (ListView) findViewById(R.id.in_situation);

        refreshPage = (SwipeRefreshLayout) findViewById(R.id.in_Swipe);
    ...
    public void refresh() {
        ...
        query.whereEqualTo("Direction", true);
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            public void done(List<ParseObject> CheckPoints, ParseException e) {
                if (e == null) {
                    ...
                    ListAdapter adapter = new ListAdapter(inSituation.this, points, imgeId, since, inOut);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_in_situation, menu);
        return true;
    }
